 ...
 * @method static mixed merge(array|int $limit = -1, boolean $cover = true, array ...$args) 合并数组
 * @method static array cover(array $args, int $limit = -1, boolean $cover = true) 覆盖数组
