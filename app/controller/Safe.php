...
class Safe extends \fxyin\Facade
{
     ...
     * @return mixed
     */
    public static function md5($var, $type = null)
    {
        // 初始化变量
        $echo = null;
        $type = intval($type);
     ...
     * @return mixed
     */
    public static function token($var, $type)
    {
        // 初始化变量
        $echo = null;
        $type = strtolower($type);
     ...
     * @return mixed
     */
    public static function rsapri($var, $type, $param = [])
    {
        // 初始化变量
        $echo = [];
     ...
     * @return mixed
     */
    public static function rsapub($var, $type, $param = [])
    {
        // 初始化变量
        $echo = [];
        if (!is_string($var) || !is_array($param)) return false;
     ...
     * @return mixed
     */
    public static function rsapem($var, $type)
    {
        // 初始化变量
