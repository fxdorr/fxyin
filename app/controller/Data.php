 ...
 * @method static string where(array $var, string $key, string $value, string $comparison, string $logic, int $rank) SQL-条件
 ...
 * @method static mixed updateContrast(array $data_new, array $data_old) 处理参数-更新比较
 ...
 * @method static mixed htmlFilter(string $string, string $flags = null) 处理HTML-过滤
 * @method static mixed htmlRemove(string $string, string $flags = null) 处理HTML-移除
 * @method static mixed listToTree(array $list, int $parent_id = 0, string $parnet_name = 'parent_id', string $index = 'id', string $child_name = '_child') 列表格式树
 * @method static mixed paramFilter(array $param) 处理参数-过滤
 * @method static mixed paramEmpty(array $param) 检查参数-空参
 * @method static mixed paramExist(array $param) 检查参数-非空
 */
